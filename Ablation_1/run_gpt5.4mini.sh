...
#---------------其他数据初始采样方法----------------
python /root/autodl-tmp/sweeteners_evolve/Ablation_1/ps_vae/sample_qm9_seeded_latent_by_property.py \
  --n_samples 1000 \
  --property gap \
  --objective min \
  --select_mode topk \
...
CUDA_VISIBLE_DEVICES=0 python /root/autodl-tmp/sweeteners_evolve/Ablation_1/hybrid/GeneticAlgorithm4Ablantion_1_fixed_NoOpt.py \
  --init_mode psvae \
  --pop_size 100 \
  --n_gen 1000 \
  --elite_size 20 \
...
# 无多轮优化版本
python /root/autodl-tmp/sweeteners_evolve/Ablation_1/hybrid/GeneticAlgorithm4Ablantion_1_fixed_NoOpt.py \
  --init_mode llm \
  --pop_size 100 \
  --n_gen 1000 \
  --elite_size 20 \
